...
def add_h_small_project_a(project_root_dir):
    repo = git.Repo(project_root_dir)
    repo.git.checkout("-b", "base")  # So we don't have to deduce whether it is main/master branch
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("small_project_a", add_h_small_project_a, ["base..."], ["test"], ["."], {"test/test_g.py", "test/test_h.py"}),
        ("medium_project_a", modify_b_1_medium_project_a, ["HEAD~1..."], ["test"], ["src"], {
        ...
        ("medium_project_a", b_2_depends_on_a_2_medium_project_a, ["HEAD~2..."], ["test"], ["src"], {
        ...
        ("medium_project_a", complex_workflow_a_medium_project_a, ["base..."], ["test"], ["src"], {
        ...
        ("medium_project_a", complex_workflow_a_medium_project_a_feature_1, ["base..."], ["test"], ["src"], {
            "test/test_a/test_a_1.py", 
            "test/test_a/test_a_3.py", 
            "test/test_b/test_b_2.py", 
            "test/test_b/test_b.py", 
